...
object ToOptionalColumns {
  ...
  implicit def toHConsColumns[C <: CqlType, N <: Singleton with String, T <: HList](implicit mapping: CqlTypeMapping[C],
                                                                                    name: ValueOf[N],
                                                                                    toTailColumns: ToOptionalColumns[T]): Aux[Column.Aux[C, N] :: T, Column.Aux[Option[mapping.MappedTo], N] :: toTailColumns.Out] = new ToOptionalColumns[Column.Aux[C, N] :: T] {
